...
| **13. equals(“Mausam”)**             | Returns true if the given string is equal to “Mausam” false otherwise [Case sensitive]                               |
| **14.equalsIgnoreCase(“mausam”)**    | Returns true if two strings are equal, ignoring the case of characters.                                              |
...
public class cwh_14_string_methods {
    public static void main(String[] args) {
        ...
        String nonTrimmedString = "     Mausam     ";
        ...
        System.out.println(name.equals("Mausam"));
        System.out.println(name.equalsIgnoreCase("MaUsAm"));
